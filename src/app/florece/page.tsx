...
export const metadata: Metadata = {
  ...
  description:
    "FLORECE: programa de transformación femenina, mentoría 1:1 y experiencia en Jet Privado con Florencia Hoffmann.",
};
    ...
    <>
      ...
      <main style={{ paddingTop: 72 }}>
        ...
        <section style={{ background: "#F2EBE0", padding: "100px 24px 80px", textAlign: "center" }}>
          <div style={{ maxWidth: 700, margin: "0 auto" }}>
            ...
            <p style={{
              ...
              Programa grupal · Mentoría 1:1 · Experiencia en Jet Privado
            </p>
          </div>
        </section>
        ...
        <section style={{ background: "#ffffff", padding: "100px 24px" }}>
          <div style={{ maxWidth: 1000, margin: "0 auto", display: "grid", gridTemplateColumns: "340px 1fr", gap: "5rem", alignItems: "center" }}>
            ...
            <div>
              ...
              <a
                href="https://buy.stripe.com/cNi9ATfixbHGgNLd1V1sQ0z"
                target="_blank"
        ...
        <section style={{ background: "#F2EBE0", padding: "100px 24px" }}>
          <div style={{ maxWidth: 1000, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 340px", gap: "5rem", alignItems: "center" }}>
            {/* Texto */}
            <div>
              <span style={{
                fontFamily: "Montserrat, sans-serif",
              ...
              <p style={{
                ...
                No necesitaba hacer más. Necesitaba aprender a habitarme mejor.
              </p>
              <p style={{
                fontFamily: "Montserrat, sans-serif",
                fontSize: "0.95rem",
                ...
                Este es un espacio para mostrarte cómo construir una vida interna que te sostenga.
                Una vida de grandeza.
              </p>
              <a
                href={`${waBase}?text=${encodeURIComponent("Hola Florencia, me interesa una mentoría 1:1 contigo. ¿Podríamos hablar?")}`}
                target="_blank"
                rel="noopener noreferrer"
                style={{
                  display: "inline-flex",
            ...
            <div style={{
              ...
              <img
                src="/mentoria-imagen.jpg"
                alt="Mentoría 1:1 con Florencia"
                style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "center" }}
              />
            </div>
          </div>
        ...
        {/* ——— BLOQUE 3: MENTORÍA EN JET PRIVADO ——— */}
        <section style={{ background: "#ffffff", padding: "100px 24px" }}>
